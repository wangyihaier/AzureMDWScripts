<#
.SYNOPSIS
  This script initializes an existing Azure Data Lake and Azure SQL DW in preparation for Module 6. Use this script if you haven't previously run Modules 1, 2, 3, and 4 of the Ready Lab
...
Write-Host "All resources initialized for module 6"
